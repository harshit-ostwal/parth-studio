...
function page() {
    return (
        <div className="flex flex-col items-center justify-center w-full min-h-screen gap-20 py-20 capitalize text-black/80">
            <div className="flex flex-col justify-between w-11/12 h-full gap-20 xl:flex-row">
                <div className="flex flex-col w-full min-h-full gap-6">
                    ...
                    <p className="text-xl font-medium">We’re ready to listen</p>
