...
function Footer() {
  ...
  return (
    <footer className="bg-white min-h-[784px] w-full flex flex-col gap-20 items-center justify-center py-20">
      <div className="flex flex-col items-center justify-between w-11/12 gap-20 xl:flex-row">
        <div className="flex flex-col w-full gap-10 max-w-7xl">
          ...
          <div className="flex flex-col gap-2 md:gap-5">
            <p>Get in touch</p>
            <h1 className="text-xl font-medium md:text-3xl">+91 00000 00000</h1>
            <h1 className="text-xl font-medium md:text-3xl">contact@parthstudios.com</h1>
            <h1 className="text-xl font-medium md:text-3xl">10th Ave, Ashok Nagar, Chennai, Tamil Nadu 600083</h1>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-between w-11/12 text-neutral-600 sm:flex-row">
